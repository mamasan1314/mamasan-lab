...
一套跨兩份檔案、共 95 頁、含 40 組跨檔重複頁的課程簡報，曾被重建為 43 頁教學版簡報（含逐頁講者備註）＋老師決策單。草稿已由 mamasan 交付，但 Tiffany 認為原文被改動過多，**未接受該版本**。

可證明的能力：

- 逐頁擷取與跨檔比對，指認重複、術語不一致與規則衝突
- **區分「真的矛盾」與「未被寫下來的作用域」**——首個案例中，一組被初版判為互相矛盾的規則，實際上是一條完整的位置規則，只是散落在十餘頁而從未單獨列出；重建後老師的學員不必再逐組硬背
- 能重建課程結構、留下來源與決策紀錄；本案也證明，若採「依義重建」而未先對齊改寫層級、又缺少信任窗口 QC／QA，技術上完整的成果仍可能無法被作者接受

已證明的是分析與製作能力；**尚未證明外部客戶接受度、付費滿意度、轉介率，以及同時處理多位老師的容量。**

## 可複用能力

| 層次 | 已有能力 |
|---|---|
| 知識體系 | 進入他人已成形的教學體系，指認未寫下的規則與內部衝突，提出可回查的重建方案；改寫程度須先約定，成果先由信任窗口 QC／QA |
